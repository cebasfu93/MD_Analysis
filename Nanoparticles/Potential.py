#CONVERTS THE OUTPUT OF CHARGE.PY INTO ELECTROSTATIC POTENTIAL
...
'charge_keys'   : ["all_gold", "L18", "NA", "CL", "SOL"], #The name of the columns in charge_file. Order matters. Last one will be read as Total
'rdf_file'      : NAME+"_rdf.sfu",
'rdf_keys'      : ["C9", "NA", "CL", "SOL"], #The name of the columns in rdf_file. Order matters
'counter_key'   : ["CL"], #Key of the counterion's rdf
