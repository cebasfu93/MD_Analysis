"""
Calculates the charge density of the system at different slices of a collective variable CV1 defined by ref1 and ref2. 
The charge density is calculated at the CV2-CV3 plane (i.e., arbitrary bases perpendicular to CV1.
"""
XTC = "MD/T2-N40-I10_L_MDfff_FIX.xtc"
TPR = "MD/T2-N40-I10_L_MDfff.tpr"
NAME = XTC[:-8]
